...
func Login(args []string) int {
	...
	if err != nil {
		fmt.Println("Invalid Parameter: <level> should be an initger.")
		return 0
	}

	exp, err := strconv.Atoi(args[3])
	if err != nil {
		fmt.Println("Invalid Parameter: <exp> should be an initger.")
		return 0
	}
...
func GetCommandJandlers() map[string]func(args []string) int {
